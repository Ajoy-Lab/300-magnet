...
%                                               obj.tabor.awg_start();
                                       ...
                                       if length(handles.Array_PSeq{1}.Channels)>=42
                                           if handles.Array_PSeq{1}.Channels(42).Enable && ~handles.Imaginghandles.ImagingFunctions.interfaceDataAcq.hasAborted
                                               ...
                                               rigol2_DC_offset=handles.Array_PSeq{helper_scan,aux}.Channels(42).PhaseQ;
                                               rigol2_phase=handles.Array_PSeq{helper_scan,aux}.Channels(42).SymmTime2;
                                              
                                               % set up third sig gen
                                               rigol3_Vpp=handles.Array_PSeq{helper_scan,aux}.Channels(42).Parameter1;
                                               rigol3_freq=handles.Array_PSeq{helper_scan,aux}.Channels(42).Parameter2;
                                               rigol3_DC_offset=handles.Array_PSeq{helper_scan,aux}.Channels(42).Parameter3;
                                               rigol3_phase=handles.Array_PSeq{helper_scan,aux}.Channels(42).Parameter4;

                                               % obtain SHAPE size
                                               M=handles.Array_PSeq{helper_scan,aux}.Channels(42).Parameter5;
                                               
                                               %obj.arb_mag2.set_sine_wave(rigol2_freq,rigol2_Vpp,0);

                                               rigol_freq=handles.Array_PSeq{helper_scan,aux}.Channels(42).FreqmodQ;
                                               % tpwr=handles.Array_PSeq{helper_scan,aux}.Channels(38).Phase;
                                                %pw_current=round(190*10^((37-tpwr)/20));

                                                  rigol_freq=1/M/(32+11+pw_current)*1e6;

%                                                rigol_freq=1/4/(32+11+pw_current)*1e6;
%                                                 rigol_freq=1/5/(32+11+pw_current)*1e6;
%                                                 rigol_freq=1/6/(32+11+pw_current)*1e6;
%                                                   rigol_freq=1/3/(32+11+pw_current)*1e6;
%   rigol_freq=1/9/(32+11+pw_current)*1e6;
%   rigol_freq=1/15/(32+11+pw_current)*1e6;
%   rigol_freq=1/21/(32+11+pw_current)*1e6;
%                                                rigol2_freq=rigol_freq; %set both frequencies to be identical
...
%                                                            pause(0.1);
                                                           ...
                                                           pause(0.1);
                                                           % this is tabor2
                                                          obj.arb_mag_tabor2.set_sine_wave(rigol_freq+rigol2_freq,rigol2_Vpp,rigol2_DC_offset,rigol2_phase,1);
%                                                           obj.arb_mag_tabor2.set_DC(rigol2_DC_offset,1);
%                                                            obj.arb_mag_tabor2.set_square_wave(rigol_freq+rigol2_freq,rigol2_Vpp,rigol2_DC_offset,1);
%                                                    
                                                           pause(0.1);
                                                           obj.arb_mag_tabor2.set_gate();
                                                           pause(0.1);
                                                            
                                                           % THIRD SIG GEN
                                                           obj.arb_mag.set_sine_wave(rigol_freq+rigol3_freq,rigol3_Vpp,rigol3_DC_offset,rigol3_phase);
%                                                         obj.arb_mag.set_sine_wave(rigol_freq+20,rigol3_Vpp,rigol3_DC_offset,rigol3_phase);
%                                                                                                           
% obj.arb_mag.set_noise(rigol_freq+rigol2_freq+10,rigol3_Vpp,rigol3_DC_offset);
                                                           pause(0.1);
