...
%                                         obj.tabor.seg=[]; %CLEAR MEMORY
                                        ...
                                        tic
       Sage_write(['6,',num2str(awg_center_freq),',',num2str(awg_bw_freq),',',num2str(awg_amp),',',num2str(sweep_freq),',',num2str(sweep_sigma),',',num2str(symm),',',num2str(srs_freq),',',num2str(srs_amp),',',num2str(t1),',',num2str(t2),',',num2str(t3),',',num2str(t4)]);         
