function [nc,nc2,nc3,T1,T2]=make_pw_nmr_13(pw,pw3,tacq,T1,T2,Tmax,rep)
...
seqfil = 'pulsed_spinlock_two_flip_angles_rep'
...
nc_max2=floor(T2*1e6/(neco*dtacq + pw3 + tdead));
nc_max3=floor((Tmax-(T1+T2)*rep)*1e6/(neco*dtacq + pw3 + tdead));
