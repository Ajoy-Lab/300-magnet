...
function [sweepTable, CHs]=AWG_supersampling_rigol(Data_AWGparam, Transfer)
tic
...
for i=1:length(Data_AWGparam(:,1))
    switch Data_AWGparam{i, 1}
        ...
        case 'n' %XY8-n
            n = floor(Data_AWGparam{i,2});
            pulse_param{8}=floor(Data_AWGparam{i,2});
...
%% Creat the optimal construction
    ...
    sample=l_sweep/1e-9-floor(l_sweep/1e-9);
