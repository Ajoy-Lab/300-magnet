p=[1 1 2 1 3 1 5 1 7 11 1 3 5 5 7];
q=[1 2 1 3 1 5 1 7 1 1 11 5 3 7 5];

for l=1:length(p)
k=6;
   
    [fid, msg] = fopen(['D:/QEG/21-C/SavedSequences/SavedSequences-PB/Misaligned_XY8_mod' num2str(k) '_' num2str(p(l)) '_' num2str(q(l))  '_2ns.xml'], 'w');
    if fid == 1
        error(msg);
    end
    fprintf(fid, '%s \n');
