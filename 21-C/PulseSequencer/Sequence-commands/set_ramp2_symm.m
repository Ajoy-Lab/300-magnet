function result_seq=set_ramp2_symm(seq,sweep_freq,Vpp1,dc_level1,phase1,bw_range1,bw_center1, Match_on_arb1,ramp1_on,symm)
...
seq.Channels(mw_channel_no).PhaseQ=symm;
result_seq = seq;
end