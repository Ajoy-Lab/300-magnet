...
%             end
        ...
        function READ_axis_out = READ_axis(obj,axis)
            ...
            clear k_n s_n ret_str_n numBytes out
        ...
        function Mov(obj, Move_n, axis)
            ...
            switch(axis)
                case {1,2}
                    ...
                    else warning('What the HELL do you think you are doing mate? You are exceeding the X or Y axis!');
                        Flag_Error=1;
                    end
                case 3
                    Move_n=Move_n-10;
                    if ((Move_n<=10)&&(Move_n>=-10)) Move_n= round(Move_n*1048574/20);
                    else warning('What the HELL do you think you are doing mate? You are exceeding the Z axis!');
                        Flag_Error=1;
                    end
                otherwise
...
%             WAVETABLE_ENABLE(obj,0,ramp_axis);
        ...
        function [n_points, piezo_sampletime]= Scan(obj, X,Y,Z, TPixel, ramp_axis) %1d scan
...
%             WAVETABLE_ENABLE(obj,0,ramp_axis);
        ...
        function NEXT_Z(obj)
            ...
            Total_Point_array=(obj.totWaveform)*1048574/20;
...
%toc
        ...
        function [n_points, piezo_sampletime]= Trigg(obj, X,Y,Z, TPixel, ramp_axis) %1d scan
