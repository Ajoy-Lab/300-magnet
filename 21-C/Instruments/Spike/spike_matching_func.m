function [final_vco_range,final_vco_volt]=spike_matching_func(pw1,arb1,bw_min,bw_max,A,B)
vco1_volt=((bw_min+bw_max)/2-A)/B;
vco1_range=(bw_max-bw_min)/B;
% vco1_volt=2.8;
% vco1_range=7;
% clear;
% close_devices();
...
d1_right=abs(bw_max-right1);
d1_left=abs(bw_min-left1);
...
% % % f_spike=sprintf('D:/New folder/xdlv/spike_data/Spike_Bc%f_Bw%f_iter%f.mat',(bw_max+bw_min)/2,bw_max-bw_min,cyc);
% % % save(f_spike,'freq_vec','data1','left1','right1','vco1_range','vco1_volt','d1_right','d1_left');
