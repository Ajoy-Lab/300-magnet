...
%                 fprintf(obj.gpib_obj,'TRIG:SLOP POS');
        ...
        function set_sine_wave(obj,freq,Vpp,DCoff,phase)
        ...
        function set_noise(obj,freq,Vpp,DCoff)
%            fprintf(obj.gpib_obj,['APPL:NOIS DEF,' num2str(Vpp) ',' num2str(DCoff)]);
%            pause(0.1);

           fprintf(obj.gpib_obj, 'FUNC NOIS');
           pause(0.1);
           fprintf(obj.gpib_obj,['VOLT ' num2str(Vpp)]);
           pause(0.1);
           fprintf(obj.gpib_obj,['VOLT:OFFS ' num2str(DCoff)]);
